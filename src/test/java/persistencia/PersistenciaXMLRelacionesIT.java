...
/**
 * Prueba de integracion: una reserva con un recurso asignado, y ese recurso
 * con su categoria, deben quedar correctamente enlazados despues de guardar
 * el XML y volver a cargarlo (no solo guardarse como texto suelto).
 */
